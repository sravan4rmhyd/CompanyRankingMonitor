angular.module('companyPortfolio.services', [])
    ...
    .factory('TradeService', ['StompClient', '$q', function (stompClient, $q) {
        ...
        return {
            ...
            loadPositions: function() {
                return stompClient.subscribeSingle("/stocks/positions");
            },
            fetchQuoteStream: function () {
                return stompClient.subscribe("/topic/price.stock.*");
            },
            fetchPositionUpdateStream: function () {
                return stompClient.subscribe("/queue/position-updates");
            },
            fetchErrorStream: function () {
                return stompClient.subscribe("/queue/errors");
            },
            sendTradeOrder: function(tradeOrder) {
                return stompClient.send("/stocks/trade", {}, JSON.stringify(tradeOrder));
            }
        };
